...
//  DreamLister
//
//  Created by Kristijan Ivanov on 11/13/17.
...
class MainVC: UIViewController, UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let objs = controller.fetchedObjects , objs.count > 0 {       // zapirkata e where (objs = controller.fetchedObjects where objs.count > 0)
    ...
    func generateTestData() {
        ...
        item.price = 1800
        item.details = "I can't wait until September event, I hope them release new MPBs"
